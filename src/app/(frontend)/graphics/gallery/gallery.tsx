						...
						>
							<Link
								...
								className="group/button absolute inset-0 overflow-clip bg-white dark:bg-neutral-950
						  		...
						  		hover:z-10 focus-visible:z-10 scale-100 hover:scale-[1.025] active:scale-[0.975] hover:bg-white dark:hover:bg-neutral-900 hover:shadow-lg active:shadow-none focus-visible:shadow-xl duration-250 ease-out-quart active:duration-75 cursor-pointer aspect-video focus-visible:animate-pulse"
							>
