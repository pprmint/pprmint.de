			...
			<div className="w-full grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 grid-rows-4 md:grid-rows-3 xl:grid-rows-2 grid-flow-dense md:max-h-[800px] border-x border-black/5 dark:border-white/5">
				<Dialog.Root>
					<Dialog.Trigger asChild>
						<button
							id="hand"
							className="group relative border-t border-r border-black/5 dark:border-white/5 active:p-2 duration-200 active:duration-75"
						>
							<div
								className="size-full flex items-center justify-center group-hover:bg-black/5 dark:group-hover:bg-white/5 duration-200 group-active:duration-75 p-6 group-active:p-4"
							>
								<FadingImage
									src={ReferenceHand}
				...
				<Dialog.Root>
					<Dialog.Trigger asChild>
						<button
							id="front"
							className="group relative row-span-2 border-t md:border-r xl:border-b border-black/5 dark:border-white/5 duration-200 active:duration-75 active:p-2"
						>
							<div
								className="size-full flex items-center justify-center group-hover:bg-black/5 dark:group-hover:bg-white/5 duration-200 group-active:duration-75 p-3 group-active:p-1"
							>
								<FadingImage
									src={ReferenceFront}
									className="w-auto max-h-full object-contain"
				...
				<Dialog.Root>
					<Dialog.Trigger asChild>
						<button
							id="back"
							className="group relative border-t border-r md:border-r-0 xl:border-r xl:border-b border-black/5 dark:border-white/5 duration-200 active:duration-75 row-span-2 active:p-2"
						>
							<div className="size-full flex items-center justify-center p-3 group-active:p-1 group-hover:bg-black/5 dark:group-hover:bg-white/5 duration-200 group-active:duration-75">
								<FadingImage
									src={ReferenceBack}
									className="w-auto max-h-full object-contain"
				...
				<Dialog.Root>
					<Dialog.Trigger asChild>
						<button
							id="hairbow"
							className="group relative md:col-span-2 xl:col-span-1 border-t md:border-b xl:border-b-0 md:border-r xl:border-r-0 border-black/5 dark:border-white/5 duration-200 active:duration-75 active:p-2"
						>
							<div
								className="size-full flex items-center justify-center gap-6 group-hover:bg-black/5 dark:group-hover:bg-white/5 duration-200 active:duration-75 p-6 group-active:p-4"
							>
								<svg
								...
								<svg
									xmlns="http://www.w3.org/2000/svg"
									viewBox="0 0 400 434"
									className="w-full max-h-full object-contain hidden md:block xl:hidden"
								>
									<path
				...
				<Dialog.Root>
					<Dialog.Trigger asChild>
						<button
							id="shoe"
							className="group relative border-y md:border-b-0 border-r xl:border-b border-black/5 dark:border-white/5 duration-200 active:duration-75 active:p-2"
						>
							<div className="size-full flex items-center justify-center group-hover:bg-black/5 dark:group-hover:bg-white/5 duration-200 active:duration-75 p-6 group-active:p-4">
								<FadingImage
									src={ReferenceShoes}
