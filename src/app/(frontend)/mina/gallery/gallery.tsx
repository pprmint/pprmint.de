						...
						>
							<Dialog.Root>
								<ContextMenu.Root>
									...
									<ContextMenu.Portal>
										<ContextMenu.Content className="text-sm p-1 min-w-64 z-99999 bg-white/90 dark:bg-neutral-950/90 backdrop-blur-sm ring-1 ring-black/5 dark:ring-white/5 shadow-xl data-[state=open]:animate-scale-up data-[state=closed]:animate-scale-down origin-[var(--radix-context-menu-content-transform-origin)]">
											<ContextMenu.Group>
