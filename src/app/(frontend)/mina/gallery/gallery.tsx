...
export default function Gallery({ artworks, page }: { artworks: PaginatedDocs<Mina>; page: number }) {
	...
	return (
		<div
			ref={galleryRef}
			className="group grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 2xl:grid-cols-7 p-1 sm:p-2 border-y border-black/5 dark:border-white/5 gap-1 sm:gap-2"
		>
															...
															{typeof artworks.docs[selectedArtwork].images[
																...
																<FadingImage
																	...
																	className={`max-h-svh w-auto mx-auto py-16 ${
																		artworks.docs[selectedArtwork].unoptimized &&
																		"pixelated"
																	}`}
																	unoptimized
																/>
