		...
		<>
			...
			<main className="max-w-7xl mx-auto px-6 md:px-9">
				...
				<section className="my-20 md:my-32 xl:my-40">
					...
					<Link href="https://twitter.com/AfkBlizzy" target="_blank" rel="noopener noreferrer" className="text-link-external">
						<h3>Blizzy</h3>
					</Link>
					<p className="pb-3">{t("Content.Credits.blizzy")}</p>
					<Link href="https://vanillatweaks.net" target="_blank" rel="noopener noreferrer" className="text-link-external">
					...
					<div className="flex gap-3 pt-6">
						<Link href="https://modrinth.com/resourcepack/mintcraft/versions" target="_blank" rel="noopener noreferrer">
							<Button tabIndex={-1} color="green">
								<svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="size-4 fill-green-950">
						...
						<Link href="https://github.com/pprmint/Mintcraft/releases" target="_blank" rel="noopener noreferrer">
							<Button tabIndex={-1} color="blue">
								<svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="size-4 fill-blue-950">
