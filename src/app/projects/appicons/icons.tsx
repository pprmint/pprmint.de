		...
		<>
			...
			{selectedPanelTransition((styles, item) =>
				item ? (
					...
					<a.div
						style={styles}
						className="fixed z-60 flex items-center justify-between left-1/2 bottom-0 xl:bottom-6 w-full xl:max-w-6xl pl-5 pr-3 py-3 bg-neutral-900 ring-1 ring-black/10 dark:ring-black/50 outline outline-1 outline-white/10 -outline-offset-1 shadow-xl xl:rounded-2xl"
					>
