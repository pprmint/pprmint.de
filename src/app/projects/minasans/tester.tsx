				...
				<div className="flex w-full md:w-auto gap-6">
					<div className="flex flex-col">
						<Select.Root value={weight} onValueChange={setWeight}>
							...
							<Select.Portal>
								<Select.Content className="z-50 text-neutral p-1 bg-elevate ring-1 ring-black/10 dark:ring-black/50 outline outline-1 outline-white/10 -outline-offset-1 shadow-lg rounded-lg data-[state=open]:animate-select-open">
