					...
					<Dialog.Root key={photo.id}>
						<Dialog.Trigger asChild>
							<button
    							...
    							hover:scale-[1.02] focus-visible:scale-[1.02] active:scale-[1.01] hover:z-10 focus-visible:z-10 justify hover:ring-1 ring-neutral-50/10 hover:shadow-2xl focus-visible:shadow-2xl duration-250 ease-out-quint active:duration-75 cursor-pointer aspect-[3/2]"
							>
								<FadingImage
						...
						<Dialog.Portal>
							...
							>
								<TransformWrapper disablePadding>
									...
									<div className="absolute flex justify-between items-center top-0 pl-6 pr-4 h-16 bg-elevate/90 inset-x-0">
									...
									<div className="absolute flex flex-col md:flex-row gap-2 items-center justify-end pb-3 md:pb-0 bottom-0 px-6 h-20 md:h-16 bg-elevate/90 inset-x-0">
