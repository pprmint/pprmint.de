					...
					<div className="flex items-center border-t sm:border-t-0 border-neutral-800">
						...
						<div className="w-full sm:w-48 gap-3">
							<Select.Root value={props.artist} onValueChange={handleSelectArtist}>
								...
								<Select.Portal>
									<Select.Content className="z-50 text-neutral p-1 bg-neutral-900 border border-neutral-950 ring-1 ring-inset ring-neutral-50/10 shadow-xl shadow-neutral-950/50 rounded-lg data-[state=open]:animate-select-open">
