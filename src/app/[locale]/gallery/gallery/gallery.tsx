                    ...
                    <Dialog.Trigger asChild>
                        ...
                        >
                            <FadingImage
                                ...
                                alt=""
                                className={`h-full min-w-full object-cover ${work.attributes.coverFocus} bg-neutral-900 [.group:hover_&:not(:hover)]:opacity-50 duration-250 ease-out-quint group-focus-visible/button:animate-pulse`}
                            />
                        </button>
                    </Dialog.Trigger>
                    <Dialog.Portal>
                        ...
                        >
                            ...
                            <Dialog.Description
                                asChild
                                className="px-6 lg:px-9 prose-a:text-link-external"
                            >
                                {!!Object.hasOwn ? (
                                    <Markdown remarkPlugins={[remarkGfm]}>
                                        {work.attributes.text}
                                    </Markdown>
                                ) : (
                                    <div>
                            ...
                            {work.attributes.gallery.data.map((media) =>
                                media.attributes.mime.startsWith("image") ? (
                                    ...
                                    media.attributes.mime.startsWith(
                                        "video"
                                    ) && (
                                        <video
                                            controls
