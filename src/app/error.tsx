...
export default function Error({
    ...
    return (
        <div className="flex items-center justify-center min-h-[calc(100vh_-_289px)] p-6 md:p-9 xl:p-0 animate-scale-up mx-9">
            <div className="bg-red/10 flex flex-col items-center justify-center w-screen md:max-w-max mx-auto border border-red rounded-xl p-6 md:p-9">
