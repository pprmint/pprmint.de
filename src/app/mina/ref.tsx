	...
	function ColorPickerToast(props: {
		...
		return (
			<Toast.Provider swipeDirection="right" duration={3000}>
				<Toast.Root
					className="flex gap-6 items-center p-3 rounded-xl shadow-lg text-neutral-50 bg-elevate ring-1 ring-black/10 dark:ring-black/50 outline outline-1 outline-white/10 -outline-offset-1 data-[state=open]:animate-toast-slide-in data-[state=closed]:animate-fade-out-scale-down data-[swipe=move]:translate-x-[var(--radix-toast-swipe-move-x)] data-[swipe=cancel]:translate-x-0 data-[swipe=cancel]:transition-[transform_200ms_ease-out] data-[swipe=end]:animate-toast-slide-out"
					open={props.open}
