			...
			<Dialog.Portal>
				...
				<Dialog.Content
					className={`fixed inset-0 lg:inset-auto overflow-auto lg:overflow-clip z-100 flex flex-col ${
						!col && "lg:flex-row"
					} gap-12 items-center lg:top-1/2 lg:left-1/2 max-h-svh lg:max-h-[90vh] w-screen max-w-7xl lg:-translate-x-1/2 lg:-translate-y-1/2 p-6 md:p-9 bg-neutral-950 border border-white/10 outline outline-1 outline-black/10 dark:outline-black/50 shadow-2xl rounded-xl data-[state=open]:animate-dialog-enter data-[state=closed]:animate-dialog-exit focus:outline-none origin-center`}
				>
					{reference}
					<div>
