					...
					<Dialog.Trigger asChild>
						<button
							className="group/button relative overflow-clip md:rounded-lg hover:rounded-lg focus-visible:rounded-lg bg-neutral-950
    							...
    							hover:scale-[1.03] focus-visible:scale-[1.03] active:scale-[1.015] hover:z-10 focus-visible:z-10 justify ring-1 ring-inset ring-neutral-50/10 hover:shadow-2xl focus-visible:shadow-2xl duration-250 ease-out-quart active:duration-75 cursor-pointer aspect-square"
						>
							<FadingImage
