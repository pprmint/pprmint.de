					...
					<div className="flex items-center border-t sm:border-t-0 border-neutral-800">
						...
						<div className="w-full sm:w-48 gap-3">
							<Select.Root value={props.artist} onValueChange={handleSelectArtist}>
								...
								<Select.Portal>
									<Select.Content className="z-50 text-neutral p-1 bg-elevate ring-1 ring-black/10 dark:ring-black/50 outline outline-1 outline-white/10 -outline-offset-1 shadow-xl rounded-lg data-[state=open]:animate-select-open">
