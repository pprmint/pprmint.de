		...
		<html lang={locale} suppressHydrationWarning>
			<body className="bg-neutral-950 selection:bg-green selection:text-neutral-950 text-neutral focus-visible:outline-none focus-visible:ring-2 overflow-x-hidden">
				<ThemeProvider attribute="class" enableSystem={false} defaultTheme="dark">
					<noscript>
						<div className="selection:bg-red fixed flex z-100 bottom-6 left-1/2 -translate-x-1/2 min-h-9 w-[92vw] max-w-max bg-gradient-to-b from-red-800 to-red-900 ring-inset ring-1 ring-red/10 border border-neutral-950 rounded-[18px] font-sans text-neutral-50 shadow-xl shadow-neutral-950/50">
