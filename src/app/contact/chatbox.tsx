		...
		<Dialog.Root>
			<Dialog.Trigger asChild>
				<button className="group relative flex items-center ring-2 hover:ring-8 ring-neutral hover:ring-transparent rounded-md rounded-tl-xl rounded-br-xl hover:rounded-md duration-500 ease-out-expo">
					...
					<div className="z-10 flex whitespace-nowrap items-center gap-3 px-3 hover:px-4 font-serif hover:font-bold text-3xl text-neutral-50 bg-neutral-950 group-focus-visible:bg-neutral-800 rounded-md rounded-tl-xl rounded-br-xl group-hover:rounded-md duration-500 ease-out-expo">
