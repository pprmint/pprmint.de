			...
			<main>
				...
				<section className="group relative w-full overflow-clip border-y border-y-neutral-900">
					...
					<Image
						src={Letter}
						alt=""
						className="absolute -z-10 w-1/2 md:w-1/3 h-auto bottom-0 md:top-1/2 md:-translate-y-1/2 right-0 xl:right-12 2xl:right-40 opacity-50 light:invert"
					/>
				</section>
				<section className="group relative w-full overflow-clip border-b border-b-neutral-900">
					...
					<Image
						src={Bubbles}
						alt=""
						className="absolute -z-10 w-1/2 md:w-1/4 h-auto bottom-0 md:top-1/2 md:-translate-y-1/2 right-0 xl:right-16 2xl:right-48 opacity-50 light:invert"
					/>
				</section>
			</main>
		</>
