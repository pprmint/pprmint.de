		...
		>
			<Link className="absolute z-90 left-6 md:left-[33px] top-3.5" href="/">
				<svg
					...
					viewBox="0 0 157 35"
					className="h-auto w-[157px] mt-[3px]"
				>
					<path
						fill="currentColor"
					...
					<defs>
						...
						>
							...
							<stop
								offset="1"
								style={{ stopColor: "currentColor", stopOpacity: 0.66 }}
							/>
						</linearGradient>
						<linearGradient
							id="pprmint.d"
						...
						<div className="w-full h-max col-span-2 pt-8 md:pt-20 xl:pt-4.5">
							...
							<ul className="md:grid grid-cols-2">
								...
								{Projects.map((Project, index) => (
									<NavLink
										key={index}
										string={`Work.Projects.${Project.strings}`}
										href={Project.link}
									/>
								))}
								<NavLink
									string="Work.Projects.More"
									href="/projects"
									noDescription
								/>
							</ul>
