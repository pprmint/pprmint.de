		...
		>
			{bgFadeIn((styles, item) =>
				item ? (
					<a.div
						style={styles}
						// @ts-expect-error
						className="absolute top-0 inset-x-0 bg-white/90 dark:bg-neutral-950/90 h-full backdrop-blur-xl border-b border-black/5 dark:border-white/5"
					/>
				) : null
			)}
			<Link href="/" className="z-80 my-auto grow md:grow-0 animate-nav-enter" style={{ animationDelay: ".15s" }}>
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 282 59" className="h-auto w-[150px] mt-1">
					...
					/>
					<g style={{ opacity: inverted && !solid ? 0 : 1, transitionDuration: "0.3s" }}>
						<path
					...
					<g style={{ opacity: inverted && !solid ? 1 : 0, transitionDuration: "0.3s" }}>
						<path
							d="M248.04 46.2v-5.05h9.93c9.95 0 18.03-8.07 18.03-18.02V13.2h5.04v9.93a23.08 23.08 0 0 1-23.07 23.07z"
							fill="url(#pprmint.c)"
						/>
					...
					<defs>
						...
						>
							...
							<stop offset="1" style={{ stopColor: "#fff", stopOpacity: .66 }} />
						</linearGradient>
						<linearGradient
							id="pprmint.d"
							x1="0"
