								...
								>
									...
									>
										<Tooltip.Root>
											...
											<Tooltip.Content
												className="data-[state=delayed-open]:animate-tooltip-enter-top data-[state=instant-open]:animate-tooltip-enter-top
											data-[state=closed]:animate-tooltip-exit-top
													select-none rounded-xl border border-neutral-800 bg-neutral-900 px-3 py-2 text-sm max-w-sm leading-none shadow-xl"
												side="bottom"
											>
												{t("Theme.lightInfo")}
