				...
				<div className="w-full border-x border-black/5 dark:border-white/5 pt-10 lg:pt-20 xl:pt-40">
					<div className="h-36 overflow-clip">
						<svg
							...
							viewBox="0 0 972 600"
							className="group h-full w-auto mx-auto cursor-grab active:cursor-grabbing fill-neutral-50 dark:fill-neutral-900"
							...
							<div
								...
								className={`inline-flex items-center justify-center text-sm w-9 h-[27px] ${
									currentLocale === locale
										...
										: "hover:bg-neutral-950/5 hover:dark:bg-neutral-50/5"
