...
export default function ArtCreditButton(props: PropsWithChildren<{ link: string }>) {
	...
	return (
		...
		>
			<button className="inline-flex p-0.5 items-center gap-1 text-neutral-50 text-sm px-3 py-1 hover:bg-neutral-50/10 active:opacity-75 rounded-full border border-neutral-50/10 duration-100 active:duration-75">
