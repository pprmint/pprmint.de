...
export default function Button({
	...
	const styles = rest.disabled
		...
		? color === "red"
			...
			: color === "yellow"
			? "bg-yellow/10 text-yellow-600 dark:text-yellow hover:bg-yellow hover:text-yellow-950 active:bg-yellow-600"
			: color === "green"
			? "bg-green/10 text-green-600 dark:text-green hover:bg-green hover:text-green-950 active:bg-green-600"
			: color === "blue"
			? "bg-blue/10 text-blue-600 dark:text-blue hover:bg-blue hover:text-blue-950 active:bg-blue-600"
			: color === "violet"
		...
		: design === "outlined"
		? color === "red"
			? "ring-1 ring-inset ring-red/10 hover:ring-red text-red-600 dark:text-red hover:bg-red/20 active:bg-red/10 active:ring-4 active:ring-transparent"
			: color === "yellow"
			...
			: color === "green"
			? "ring-1 ring-inset ring-green/10 hover:ring-green text-green-600 dark:text-green hover:bg-green/20 active:bg-green/10 active:ring-4 active:ring-transparent"
			: color === "blue"
			? "ring-1 ring-inset ring-blue/10 hover:ring-blue text-blue-600 dark:text-blue hover:bg-blue/20 active:bg-blue/10 active:ring-4 active:ring-transparent"
			: color === "violet"
			? "ring-1 ring-inset ring-violet/10 hover:ring-violet text-violet-600 dark:text-violet hover:bg-violet/20 active:bg-violet/10 active:ring-4 active:ring-transparent"
			: color === "neutral" &&
		...
		? "text-red-600 dark:text-red hover:bg-red hover:text-red-950 active:bg-red-600"
		: color === "yellow"
		? "text-yellow-600 dark:text-yellow hover:bg-yellow hover:text-yellow-950 active:bg-yellow-600"
		: color === "green"
		? "text-green-600 dark:text-green hover:bg-green hover:text-green-950 active:bg-green-600"
		: color === "blue"
		? "text-blue-600 dark:text-blue hover:bg-blue hover:text-blue-950 active:bg-blue-600"
		: color === "violet"
		? "text-violet-600 dark:text-violet hover:bg-violet hover:text-violet-950 active:bg-violet-600"
		: color === "neutral" &&
	...
	return (
		<button
			...
			} ${size === "regular" ? "duration-100" : "duration-200 font-medium"} ease-out ${padding} ${
