...
export default function Button({
	...
	const colors = rest.disabled
		...
		? outlined
			...
			: "text-red-950 bg-gradient-to-t dark:bg-gradient-to-b from-red to-red-400 dark:to-red-600 border-b border-b-red-700 active:border-b-red-600 border-t border-t-red-300 active:border-t-red-700 hover:brightness-110 active:brightness-90 active:shadow-inner"
		: color === "orange"
		? outlined
			...
			: "text-orange-950 bg-gradient-to-t dark:bg-gradient-to-b from-orange to-orange-400 dark:to-orange-600 border-b border-b-orange-700 active:border-b-orange-600 border-t border-t-orange-300 active:border-t-orange-700 hover:brightness-110 active:brightness-90 active:shadow-inner"
		: color === "yellow"
		? outlined
			...
			: "text-yellow-950 bg-gradient-to-t dark:bg-gradient-to-b from-yellow to-yellow-400 dark:to-yellow-600 border-b border-b-yellow-700 active:border-b-yellow-600 border-t border-t-yellow-300 active:border-t-yellow-700 hover:brightness-110 active:brightness-90 active:shadow-inner"
		: color === "lime"
		? outlined
			...
			: "text-lime-950 bg-gradient-to-t dark:bg-gradient-to-b from-lime to-lime-400 dark:to-lime-600 border-b border-b-lime-700 active:border-b-lime-600 border-t border-t-lime-300 active:border-t-lime-700 hover:brightness-110 active:brightness-90 active:shadow-inner"
		: color === "green"
		? outlined
			...
			: "text-green-950 bg-gradient-to-t dark:bg-gradient-to-b from-green to-green-400 dark:to-green-600 border-b border-b-green-700 active:border-b-green-600 border-t border-t-green-300 active:border-t-green-700 hover:brightness-110 active:brightness-90 active:shadow-inner"
		: color === "cyan"
		? outlined
			...
			: "text-cyan-950 bg-gradient-to-t dark:bg-gradient-to-b from-cyan to-cyan-400 dark:to-cyan-600 border-b border-b-cyan-700 active:border-b-cyan-600 border-t border-t-cyan-300 active:border-t-cyan-700 hover:brightness-110 active:brightness-90 active:shadow-inner"
		: color === "blue"
		? outlined
			...
			: "text-blue-950 bg-gradient-to-t dark:bg-gradient-to-b from-blue to-blue-400 dark:to-blue-600 border-b border-b-blue-700 active:border-b-blue-600 border-t border-t-blue-300 active:border-t-blue-700 hover:brightness-110 active:brightness-90 active:shadow-inner"
		: color === "violet"
		? outlined
			...
			: "text-violet-950 bg-gradient-to-t dark:bg-gradient-to-b from-violet to-violet-400 dark:to-violet-600 border-b border-b-violet-700 active:border-b-violet-600 border-t border-t-violet-300 active:border-t-violet-700 hover:brightness-110 active:brightness-90 active:shadow-inner"
		: color === "pink"
		? outlined
			...
			: "text-pink-950 bg-gradient-to-t dark:bg-gradient-to-b from-pink to-pink-400 dark:to-pink-600 border-b border-b-pink-700 active:border-b-pink-600 border-t border-t-pink-300 active:border-t-pink-700 hover:brightness-110 active:brightness-90 active:shadow-inner"
		: outlined
