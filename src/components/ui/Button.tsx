			...
			: design === "semi-transparent"
				...
				: design === "outlined"
					? color === "red"
						...
						: color === "yellow"
							? "ring-1 ring-inset ring-yellow/10 hover:ring-yellow text-yellow-600 dark:text-yellow hover:bg-yellow/10 active:bg-yellow/20 active:ring-4 active:ring-transparent"
							: color === "green"
								? "ring-1 ring-inset ring-green/10 hover:ring-green text-green-600 dark:text-green hover:bg-green/10 active:bg-green/20 active:ring-4 active:ring-transparent"
								: color === "blue"
									? "ring-1 ring-inset ring-blue/10 hover:ring-blue text-blue-600 dark:text-blue hover:bg-blue/10 active:bg-blue/20 active:ring-4 active:ring-transparent"
									: color === "violet"
