...
function DesktopNavigation() {
	...
	function MenuItem(
		...
		const highlight = !props.disableHighlight && props.href === route && "pointer-events-none";
		return (
			<li>
				<NavigationMenu.Link
					asChild
				...
				>
					<Link href={props.href} locale={props.locale} scroll={props.scroll}>
						<span className="text-neutral-50 font-display font-semibold text-xl pb-0.5">
							{!props.disableHighlight && props.href === route && (
...
function MobileNavigation() {
	...
	function ListItem(
		...
		const highlight = !props.disableHighlight && props.href === route && "text-neutral-50";
		return (
			<Link href={props.href} locale={props.locale} onClick={handleClose}>
				<li
