		...
		<Tooltip.Provider>
			<Tooltip.Root>
				<div className="fixed flex items-center justify-center bg-neutral-950/75 md:backdrop-blur-md z-50 inset-0">
					<div className="fixed z-40 md:p-24 h-screen w-screen">
						<div onClick={onClose} className="fixed inset-0" />
						{flyoutTransition((style, work) => (
							<a.div key={work.id} style={style} className="flex max-w-6xl mx-auto drop-shadow-xl">
								<div className="w-full h-screen max-h-svh md:h-max bg-neutral-950 md:border border-neutral-50/10 md:rounded-xl overflow-auto">
									<div className="relative overflow-hidden h-60 md:h-1/3-screen">
										<button
