			...
			<main className="max-w-7xl mx-auto px-6 md:px-9">
				<section className="my-24 flex flex-col items-center justify-center">
					...
					>
						...
						<div className="z-10 flex flex-nowrap items-center gap-6 px-3 hover:px-4 font-display font-medium text-3xl text-neutral-50 bg-neutral-950 rounded-md rounded-tl-xl rounded-br-xl group-hover:rounded-md duration-500 ease-out-expo">
							<svg
